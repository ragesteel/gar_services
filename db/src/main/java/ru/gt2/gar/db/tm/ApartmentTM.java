...
@Generated(
        ...
        date = "2026-03-13T18:35:21.0699408+03:00"
)
public class ApartmentTM extends AbstractTableMapping<Apartment, Long> {
    public ApartmentTM() {
        super(Apartment::id);
    }

    @Override
    public void write(Apartment source, PreparedStatement ps) throws SQLException {
    ...
    @Override
    public Apartment read(ResultSet rs) throws SQLException {
        ...
        return new Apartment(id, objectId, objectGuid, changeId, number, apartType, operTypeId, prevId, nextId, updateDate, startDate, endDate, isActual, isActive);
    }
}
