...
@Generated(
        ...
        date = "2026-03-09T18:24:40.7850565+03:00"
)
public class SQLQueries {
    private static final ImmutableMap<GarType, GeneratedSQL> MAP = ImmutableMap.<GarType, GeneratedSQL>builder()
                ...
                .put(GarType.APARTMENT_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active" FROM apartment_types WHERE "id" = ANY(?)""", """
                        INSERT INTO apartment_types ("id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
                ...
                .put(GarType.HOUSE_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active" FROM house_types WHERE "id" = ANY(?)""", """
                        INSERT INTO house_types ("id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
                ...
                .put(GarType.OPERATION_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active" FROM operation_types WHERE "id" = ANY(?)""", """
                        INSERT INTO operation_types ("id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.PARAM_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "code", "desc", "update_date", "start_date", "end_date", "is_active" FROM param_types WHERE "id" = ANY(?)""", """
                        INSERT INTO param_types ("id", "name", "code", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
                ...
                .put(GarType.ROOM_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active" FROM room_types WHERE "id" = ANY(?)""", """
                        INSERT INTO room_types ("id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
                ...
                .put(GarType.ADDR_OBJ_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM addr_obj_params WHERE "id" = ANY(?)""", """
                        INSERT INTO addr_obj_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.HOUSES_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM houses_params WHERE "id" = ANY(?)""", """
                        INSERT INTO houses_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.APARTMENTS_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM apartments_params WHERE "id" = ANY(?)""", """
                        INSERT INTO apartments_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.ROOMS_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM rooms_params WHERE "id" = ANY(?)""", """
                        INSERT INTO rooms_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.STEADS_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM steads_params WHERE "id" = ANY(?)""", """
                        INSERT INTO steads_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.CARPLACES_PARAMS, new GeneratedSQL("BIGINT", """
                        SELECT "id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date" FROM carplaces_params WHERE "id" = ANY(?)""", """
                        INSERT INTO carplaces_params ("id", "object_id", "change_id", "change_id_end", "type_id", "value", "update_date", "start_date", "end_date") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"""))
                .put(GarType.ADDHOUSE_TYPES, new GeneratedSQL("INT", """
                        SELECT "id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active" FROM addhouse_types WHERE "id" = ANY(?)""", """
                        INSERT INTO addhouse_types ("id", "name", "short_name", "desc", "update_date", "start_date", "end_date", "is_active") VALUES (?, ?, ?, ?, ?, ?, ?, ?)"""))
        .build();;
