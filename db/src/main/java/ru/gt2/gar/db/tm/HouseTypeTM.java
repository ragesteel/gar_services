...
@Generated(
        ...
        date = "2026-03-13T18:35:21.0869402+03:00"
)
public class HouseTypeTM extends AbstractTableMapping<HouseType, Integer> {
    public HouseTypeTM() {
        super(HouseType::id);
    }

    @Override
    public void write(HouseType source, PreparedStatement ps) throws SQLException {
    ...
    @Override
    public HouseType read(ResultSet rs) throws SQLException {
        int id = rs.getInt(1);
        ...
        return new HouseType(id, name, shortName, desc, updateDate, startDate, endDate, isActive);
    }
}
