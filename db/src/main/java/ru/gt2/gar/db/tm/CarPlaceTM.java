...
@Generated(
        ...
        date = "2026-03-13T18:35:21.0779408+03:00"
)
public class CarPlaceTM extends AbstractTableMapping<CarPlace, Long> {
    public CarPlaceTM() {
        super(CarPlace::id);
    }

    @Override
    public void write(CarPlace source, PreparedStatement ps) throws SQLException {
    ...
    @Override
    public CarPlace read(ResultSet rs) throws SQLException {
        ...
        return new CarPlace(id, objectId, objectGuid, changeId, number, operTypeId, prevId, nextId, updateDate, startDate, endDate, isActual, isActive);
    }
}
