/**
 * FIXME Похоже самый правильный способ - это не писать прямо в базу данных, а создавать текстовый файл,
 * который потом импортируется в базу (для MySQL - с помощью mysqlimport'а).
 *
 * FIXME Подключить использование библиотеки для CSV, например OpenCSV. Ещё поискать на stackoverflow.
 *
