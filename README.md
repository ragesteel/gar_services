...
- [gar-parse](parse.md): получение и обработка адресных данных;
- [gar-db](db.md): работа с базой данный, создание схемы, загрузка данных, пока только для PostgreSQL; 
- gar-fias-client: клинет к вебсервису ФИАС, для получения информация о файлах для загрузки;
- gar-domain: доменная модель, объектное представление содержимого XML-файлов выгрузки;
- gar-codegen: генератор схемы базы, разбора атрибутов XML и тому подобное из данных доменной модели;
